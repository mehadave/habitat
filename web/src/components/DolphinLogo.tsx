...
export function DolphinLogo({ size = 40, className }: DolphinLogoProps) {
  return (
    ...
    >
      {/* Body - dark navy base */}
      <ellipse cx="28" cy="34" rx="18" ry="13" fill="#1e3a8a" />

      {/* Upper body - bright blue highlight */}
      <path
        d="M12 28 Q18 18 28 20 Q38 18 44 28 Q38 26 28 27 Q18 26 12 28Z"
        fill="#2563eb"
      />

      {/* Dorsal fin - sky blue swept back */}
      <path
      ...
      {/* Eye white */}
      <ellipse cx="22" cy="27" rx="4" ry="3.5" fill="#dbeafe" />

      {/* Pupil */}
      <circle cx="22.5" cy="27" r="2" fill="#1e3a8a" />
