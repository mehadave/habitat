    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#0B1437' }}>
      ...
      >
        ...
        <div className="rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.09)' }}>
          {/* Mode tabs */}
          <div className="flex gap-2 mb-6 p-1 rounded-xl" style={{ background: 'rgba(255,255,255,0.06)' }}>
            <button
              onClick={() => setMode('email')}
              className="flex-1 py-2 rounded-lg text-sm font-medium transition-all"
              style={{
                background: mode === 'email' ? '#2563EB' : 'transparent',
                color: mode === 'email' ? '#fff' : 'rgba(255,255,255,0.55)',
              }}
            >
              Email
            </button>
            <button
              ...
              className="flex-1 py-2 rounded-lg text-sm font-medium transition-all"
              style={{
                background: mode === 'phone' ? '#2563EB' : 'transparent',
                color: mode === 'phone' ? '#fff' : 'rgba(255,255,255,0.55)',
              }}
            >
              Phone
            </button>
        ...
        <div className="flex justify-center gap-4 mt-4 text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>
