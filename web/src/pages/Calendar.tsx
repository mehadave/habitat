  ...
  return (
    <div className="app-bg min-h-screen" style={{ paddingTop: 76, paddingBottom: 80 }}>
      <div className="px-4 pt-8 page-inner">
          ...
          {habits.length > 0 && (
            <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar">
              ...
              {habits.map((h, i) => {
                ...
                return (
                  <button key={h.id} onClick={() => toggleFilter(h.id)}
        ...
        {/* Mobile: title alone, filters centred below */}
        <div className="md:hidden">
          <h1 className="text-2xl font-bold mb-2" style={{ color: t.text }}>Calendar</h1>
          {habits.length > 0 && (
            <div className="flex items-center justify-center gap-1.5 overflow-x-auto no-scrollbar mb-4 pb-0.5">
              <button
                onClick={() => setFilterIds([])}
